const BasicReader = require('./BasicReader');
const { } = require('./commands/ACR_Commands');

class ACR_Reader extends BasicReader {
    constructor(reader) {
        super(reader);
    }
    ...
    async autoPoll() {
        ...
        try {
            ...
            console.log(response.subarray(1));
    ...
    async setLedState(state, blinking) {
    ...
    async setBuzzerEnabled(enabled = true) {
